...
/**
 * Raw SQL Payments Escrow System Test - Bypasses Prisma Schema Issues
 */

const { PrismaClient } = require('@prisma/client');

async function testEscrowSystem() {
  console.log('í·ª Testing Escrow Payment System (Raw SQL Payments)...\n');
  ...
  try {
    ...
    // Test 4: Create test payment using RAW SQL to avoid Prisma schema issues
    ...
    testData.jobProof = await prisma.jobProof.create({
      data: {
        ...
        provider_id: testData.providerRecord.id,
    ...
    console.log(' Note: Used raw SQL to bypass Prisma schema issues');
