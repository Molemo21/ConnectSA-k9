...
/**
 * Core Payment System Test - Focus on Escrow Payment Flow
 */

const { PrismaClient } = require('@prisma/client');

async function testCorePaymentSystem() {
  console.log('í·ª Testing Core Escrow Payment System...\n');
  ...
  try {
    ...
    console.log('í³ Note: Provider-service relationship skipped (foreign key constraint issue)');
