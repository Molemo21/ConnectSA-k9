...
/**
 * Core Payment System Test - Fixed Version with totalAmount
 */

const { PrismaClient } = require('@prisma/client');

async function testCorePaymentSystem() {
  console.log('í·ª Testing Core Escrow Payment System (Fixed)...\n');
  ...
  try {
    ...
    // Test 3: Create test booking with ALL required fields including totalAmount
    ...
    testData.booking = await prisma.booking.create({
      data: {
        ...
        totalAmount: 1000.0 // Added the missing required field
      }
    });
