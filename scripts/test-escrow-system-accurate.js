...
/**
 * Accurate Escrow Payment System Test - Matches Your Exact Schema
 */

const { PrismaClient } = require('@prisma/client');

async function testEscrowSystem() {
  console.log('í·ª Testing Escrow Payment System (Accurate Schema)...\n');
  ...
  try {
    ...
    // Test 3: Create test booking with ALL required fields from your schema
    ...
    // Test 4: Create test payment with required fields from your schema
    ...
    // Test 5: Create test job proof with required fields from your schema
    ...
    // Test 6: Create test payout with required fields from your schema
    ...
    console.log('   Note: All required fields from your exact schema included');
...
process.on('SIGTERM', async () => {
  console.log('\nï¿½ï¿½ Received SIGTERM, cleaning up...');
  process.exit(0);
});
