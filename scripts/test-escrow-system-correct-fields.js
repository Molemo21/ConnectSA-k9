...
/**
 * Correct Fields Escrow Payment System Test - Uses Right Field Names
 */

const { PrismaClient } = require('@prisma/client');

async function testEscrowSystem() {
  console.log('í·ª Testing Escrow Payment System (Correct Fields)...\n');
  ...
  try {
    ...
    // Test 4: Create test payment with CORRECT field names
    ...
    console.log(' Note: All fields now use correct names from your schema');
